...
public class NpgsqlMathMinMaxGoldenSqlTests
{
    [Fact]
    ...
    public void Max_column_and_static_emits_greatest()
    {
        ...
        Assert.Equal(10, NpgsqlHarness.Params(parameters)["@p0"]);
    }
    ...
    public void Min_static_and_column_preserves_arg_order()
    {
        ...
        Assert.Equal(5, NpgsqlHarness.Params(parameters)["@p0"]);
    }
    ...
    public void Min_column_and_column_has_no_assignment_params()
    {
        ...
        Assert.Equal(1, NpgsqlHarness.Params(parameters)["@p0"]);
    }
    ...
    public void Min_nested_round_with_column_cap()
    {
        ...
        Assert.Equal(4, NpgsqlHarness.Params(parameters)["@p0"]);
    }
    ...
    public void Min_static_only_folds_to_parameter()
    {
        ...
        Assert.Equal(3, NpgsqlHarness.Params(parameters)["@p0"]);
    }
    ...
    [Fact]
    public void Upsert_computed_max_uses_qualified_column()
    {
        var (sql, _) = NpgsqlHarness.GenerateSingle(b => b
            .Upsert<Item>(u => u
                .MatchOn(x => x.Id)
        ...
        Assert.Contains("GREATEST(\"Items\".\"Key2\", @p", sql);
