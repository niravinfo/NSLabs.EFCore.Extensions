...
public class NpgsqlUpsertExecutionTests : NpgsqlTestBase
{
    public NpgsqlUpsertExecutionTests(NpgsqlFixture fixture) : base(fixture) { }
    ...
    public async Task Upsert_with_guard_skips_update_when_guard_false()
    {
        ...
        // Guard false -> 0 rows affected, existing row untouched
